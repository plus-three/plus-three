...
// 排除的包
export const external = ['three', 'lodash-es', new RegExp('three/examples/jsm/*')]
...
// 排除的文件
const excludes = ['node_modules', '__tests__', 'dist']
...
export const pathRewriter = (id: string) => {
  id = id.replaceAll(`@plus-three/types`, `../types`)
  id = id.replaceAll(`@plus-three/utils`, `../utils`)
  return id
}
